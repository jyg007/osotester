...
[ -f /var/lib/libvirt/images/backendplugintester-data.qcow2 ] || qemu-img create -f qcow2 /var/lib/libvirt/images/backendplugintester-data.qcow2 10G

LOCAL_PLAY="./testerdata" 

DOMAIN="backendplugintester"
XML="$LOCAL_PLAY/domain_back.xml"
...
envsubst < $LOCAL_PLAY/env_back.tpl > $ENV
...
echo "local-hostname: backendplugintester" > $LOCAL_PLAY/meta-data

#genisoimage -output /var/lib/libvirt/images/backendplugintester-cloudinit -volid cidata -joliet -rock vendor-data user-data meta-data network-config
genisoimage -quiet -output /var/lib/libvirt/images/backendplugintester-cloudinit -volid cidata -joliet -rock $LOCAL_PLAY/vendor-data $LOCAL_PLAY/user-data $LOCAL_PLAY/meta-data 

qemu-img create -q -f qcow2 /var/lib/libvirt/images/backendplugintester-overlay.qcow2 10G
